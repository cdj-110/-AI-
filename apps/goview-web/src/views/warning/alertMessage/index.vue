<template>
    <div>
        <el-dialog v-model="dialogVisible" width="1200" @close="emit('alarmHistoryClose', false)">
            <div class="Alarm">
                ...
                <div class="Alarm_form">
                    <el-form :inline="true" :model="formInline" class="demo-form-inline Alarm_splice">
                        <div>
                            <el-form-item>
                                <el-select v-model="formInline.region" placeholder="所有状态" style="width: 10rem;">
                        ...
                        <div>
                            <el-form-item>
                                <el-input v-model="formInline.title" placeholder="告警名称/设备名称/设备类型" clearable
                                    style="width: 13rem;" />
                            </el-form-item>
                            <el-form-item>
                                    ...
                                    <div class="alert-details">
                                        <div style="display: flex;justify-content: space-between;">
                                            <h4 :class="['alert-title', `alert-title-${alert.level}`]">
                                                {{ getAlertLevelText(alert.level) }}告警
                                            </h4>
                                            <div style="font-size: 0.75rem;padding: 0 2rem 0 0;">
                                                {{ alert.description }}
                                            </div>
                                        </div>
                                        <p class="alert-metric">二氧化碳：{{ alert.co2 }}ppm</p>
                                        <p class="alert-metric">
                                            <span>
                                                所属设备：<span style="color: #79BBFF;">{{ alert.device }}</span>
                                            </span>
                ...
                <div style="display: flex;justify-content:center;margin: 0.7rem 0 3rem 0;align-items: center;">
                ...
                <div style="display: flex;justify-content: flex-end;margin: 0.7rem 0 0 0;">
                    <el-button plain @click="emit('alarmHistoryClose', false)">关闭页面</el-button>
                </div>
...
import alarmRule from '../warningChronicle/alarmRule.vue'
...
let emit = defineEmits(["alarmHistoryClose"]);
